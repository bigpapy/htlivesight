htlivesight.constants.IMG_PATH = htlivesightEnv.contentPath+"img/";htlivesight.Image = {		  htlivesight: htlivesight.constants.IMG_PATH + "foxball_32.png",
  live: {
    ON: htlivesight.constants.IMG_PATH + "wboxshade1.png",
    OFF: htlivesight.constants.IMG_PATH + "wboxopen1.png"
  },    shortBox: {	  	  OPEN : htlivesight.constants.IMG_PATH + "wboxclose1.png",	  	  CLOSE : htlivesight.constants.IMG_PATH + "wboxclose0.png"  },
  window: {
    close: {
  ...
  friend: {
    ...
    },        move: {        UP: htlivesight.constants.IMG_PATH + "up.png",        DOWN: htlivesight.constants.IMG_PATH + "down.png"      }
  },
  weather: {
