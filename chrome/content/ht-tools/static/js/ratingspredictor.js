...
var parseGet = function(xml,teamId){
	...
	for(i = 0; i < players.length; i++){
		...
		//$('#players').append('<input type="checkbox" id="'+playerID+'" name="'+playerID+'" experience="'+experience+'" leadership="'+leadership+'" playername="'+playerName+'"><label for="'+playerID+'">' + playerName + '</label><br>');2
		$('#allItems').append('<li id="'+playerID+'">'+playerName+'</li>');
	}
	$("#progress").hide();
	initDragDropScript();
}